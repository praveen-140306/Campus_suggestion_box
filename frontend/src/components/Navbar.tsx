      ...
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        {user?.role === 'admin' ? (
          <Link to="/admin" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Suggestion Portal</span>
            </div>
          </Link>
        ) : (
          <div className="flex items-center space-x-3 group cursor-default">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-teal-400 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-500/30 transition-shadow duration-300">
              <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
              </svg>
            </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg text-sm font-semibold text-rose-300 hover:bg-rose-500/15 hover:text-rose-200 transition-all duration-200 flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
