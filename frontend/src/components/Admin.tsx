                ...
                {suggestions
                  ...
                  <tr key={s._id} className="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 max-w-sm" title={s.message}>
                      ...
                      {s.attachmentUrl && (
                         <div className="mt-2">
                            <a href={`http://localhost:5000${s.attachmentUrl}`} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800 text-xs font-semibold flex items-center gap-1">
